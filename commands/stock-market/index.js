        ...
        axios.get(`https://www.avanza.se/_mobile/market/search?query=${index}`).then(res => {
            ...
            const infoEmbed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: 'Länk', value: `[${indexName} på Avanza](https://click.adrecord.com/?c=24113&p=836&epi=discord&url=https://www.avanza.se/index/om-indexet.html/${indexId}/${indexName.replaceAll(' ', '-')})` },
                )
